...
Security training records are maintained in the compliance repository (`cybersecurity-education-tracker.md`). Records include: trainee name, training date, training type, completion status, and expiration date. Records are retained for the duration of employment plus 3 years.
