...
const UUID = {
  ...
  partyOwner:         'c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f',
  roleSystemOwner:    'system-owner',
  roleISSOfficer:     'information-system-security-officer',
  roleAO:             'authorizing-official',
  componentApp:       'd4e5f6a7-b8c9-4d0e-8f2a-3b4c5d6e7f80',
  componentGCP:       'e5f6a7b8-c9d0-4e1f-8a3b-4c5d6e7f8091',
  componentChatAPI:   'f6a7b8c9-d0e1-4f2a-8b4c-5d6e7f809102',
  componentAdminAPI:  'a7b8c9d0-e1f2-4a3b-8c5d-6e7f80910213',
  componentOps:       'b8c9d0e1-f2a3-4b4c-8d6e-7f8091021324',
  componentDB:        'c9d0e1f2-a3b4-4c5d-8e7f-809102132435',
  componentGCS:       'd0e1f2a3-b4c5-4d6e-8f80-910213243546',
  componentWAF:       'e1f2a3b4-c5d6-4e7f-8091-021324354657',
  componentKMS:       'f2a3b4c5-d6e7-4f80-9102-132435465768',
  componentIdP:       'a3b4c5d6-e7f8-4091-8213-243546576879',
  componentVectorAI:  'b4c5d6e7-f809-4102-9324-35465768798a',
  componentCICD:      'c5d6e7f8-0910-4213-a435-4657687989ab',
  componentClamAV:    'd6e7f809-1021-4324-b546-57687989abbc',
  leveragedGCP:       'e7f80910-2132-4435-8657-687989abbbcd',
};
      ...
      'system-implementation': {
        ...
        components: [
          ...
          },
          {
            ...
            type: 'service',
            title: 'Cloud Storage',
            description: 'Object storage for customer documents. AES-256-GCM + CMEK, workspace-scoped paths, versioning (all versions preserved indefinitely), 90-day soft-delete recovery.',
            status: { state: 'under-development' },
          },
          {
          ...
          },
          {
            ...
            type: 'service',
            title: 'Cloud KMS',
            description: 'Customer-Managed Encryption Keys (CMEK) for Cloud SQL, GCS, BigQuery, Logging, Vertex AI, Artifact Registry, Cloud Tasks, and app secrets. AES-256 with 90-day automatic rotation, HSM-backed (FIPS 140-2 Level 3).',
            status: { state: 'under-development' },
          },
          {
