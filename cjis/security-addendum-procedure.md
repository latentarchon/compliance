...
> **Organizational context**: Latent Archon is a founder-led, automation-first security organization. CJIS procedures will be activated when a law enforcement customer requiring CJI access is onboarded. References to "Security Lead" in this document describe the target-state role (POA-15); until that hire, the CEO / ISSO fulfills all duties. See SOD-LA-001.
